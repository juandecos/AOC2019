    ...
    class AOC5_1
    {
        ...
        public int Solve()
        {
            ...
            for (int position = 0; position < data.Length;)
            {
                ...
                if (opcode == 1)
                {
                    int op1 = opModes[0] == 0 ? data[data[position + 1]] : data[position + 1];
                    int op2 = opModes[1] == 0 ? data[data[position + 2]] : data[position + 2];
                    data[data[position + 3]] = op1 + op2;
                    position += 4;
                }
                else if (opcode == 2)
                {
